...
export default function BottomComponent({color,displayWidth}){
    ...
    return(
        <div id="BottomComponent">
            <ImageEffect color={color} displayWidth={displayWidth}/>
            <Loading color={color}/>
            <div className="modelContainer">
                ...
                <div className="helpFloat" style={helpOpen?{opacity:1,pointerEvents:'auto',right:'20%',bottom:'20%',transition:'opacity 0.5s',animation:"popOpen 0.5s ease"}:{opacity:0,pointerEvents:'none',right:'-40%',bottom:'-40%'}}>
